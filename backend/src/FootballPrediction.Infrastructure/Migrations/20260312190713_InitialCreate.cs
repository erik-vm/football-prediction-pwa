        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TournamentId = table.Column<Guid>(type: "uuid", nullable: false),
                    GameWeekId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameWeeks_TournamentId_WeekNumber",
                table: "GameWeeks",
                columns: new[] { "TournamentId", "WeekNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_TournamentId_GameWeekId",
                table: "Matches",
                columns: new[] { "TournamentId", "GameWeekId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tournaments_Code_Season",
                table: "Tournaments",
                columns: new[] { "Code", "Season" },
                unique: true);
